        ...
        <div class="container-fluid courses overflow-hidden py-5" style="margin-bottom: 90px;">
            <div class="container py-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h4 class="text-primary">Nuestras rutinas</h4>
                    <h1 class="display-4 text-white mb-4">Rutinas para todos y todas</h1>
                    <p class="text-white mb-0">Rutinas para personas que puedan asistir desde 6 días y rutinas para personas que tengan tiempo límitado</p>
                </div>
                                ...
                                <div class="d-flex justify-content-between mb-4">
                                    ...
                                    <div class="data-info d-flex flex-column">
                                        <div class="courses-trainer d-flex align-items-center mb-1">
                                            <p class="mb-0">El tiempo no es excusa</p>
                                        </div>
                                        </div>
                                </div>
                                <a href="#" class="d-inline-block h4 mb-3"> Rutina para novatos</a>
                                <p class="mb-4">Rutina para aquellos que van iniciando en el gimnasio.</p>
                                <a href="rutina_novatos.html" class="btn btn-primary py-2 px-4"> <span>Más información</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="courses-item">
                            <div class="courses-item-inner p-4">
                                ...
                                <a href="#" class="d-inline-block h4 mb-3">Rutina para intermedios</a>
                                <p class="mb-4">Rutina para aquellos que ya conocen el gimnasio</p>
                                <a href="rutina_intermedio.html" class="btn btn-primary py-2 px-4"> <span>Más información</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="courses-item">
                            <div class="courses-item-inner p-4">
                                ...
                                <a href="#" class="d-inline-block h4 mb-3">Rutina para avanzados</a>
                                <p class="mb-4">Rutina para aquellos que ya son expertos en el gimnasio</p>
                                <a href="rutina_avanzado.html" class="btn btn-primary py-2 px-4"> <span>Más información</span></a>
                            </div>
                        </div>
                    </div>
